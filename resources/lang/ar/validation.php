...
return [
    ...
    */
    ...
    'custom' => [
        ...
        'total_value' => [
            'not_in' => "تم تحصيل المبلغ لهذه الشركة من قبل"
        ],
        'type' => [
            'required' => 'حقل ( :attribute ) مطلوب',
            'in' => 'يجب أن يكون نوع رؤية او رسالة'
        ]
    ...
    */
    ...
    'attributes' => [
        ...
        'privacy.*.name_ar' => 'عنوان سياسية الخصوصية بالعربية',
        'privacy.*.name_en' => 'عنوان سياسية الخصوصية بالانجليزية',
        'privacy.*.content_ar' => 'محتوي سياسية الخصوصية بالعربية',
        'privacy.*.content_en' => 'محتوي سياسية الخصوصية بالانجليزية',
        'color' => 'اللون',
        'payment_image' => 'صورة الدفع',
        'total_value' => 'اجمالي التحصيلات',
        'hex_code' => 'كود اللون',
        'gender' => 'الجنس',
        'parking_time_id' => 'وقت الركنة',
        'images' => 'الصور',
        'time' => 'الوقت',
        ...
        'main_page' => 'الصفحة الأساسية',
        'parking_price_list_id' => 'وقت الركنة',
        'model_id' => 'فئة المركبة',
        'color_id' => 'لون المركبة',
