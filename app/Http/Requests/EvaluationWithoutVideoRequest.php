...
class EvaluationWithoutVideoRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        return [
            ...
            'evaluate_ar' => ['required', 'string', 'max:255',new NotNumbersOnly()],
            'evaluate_en' => ['required', 'string', 'max:255',new NotNumbersOnly()],
        ];
    }
}
