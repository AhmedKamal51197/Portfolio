...
class ProfessionalAppreciationRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'cards' => ['required', 'array', 'min:3', 'max:3'], // ⬅️ تعديل هنا
    ...
    public function messages(): array
    {
        return app()->getLocale() === 'ar'
            ? [
                ...
                'cards.min' => 'يجب إدخال ثلاث بطاقات بالضبط.',
                'cards.max' => 'يجب إدخال ثلاث بطاقات بالضبط.',

                'cards.*.position.required' => 'يجب تحديد ترتيب البطاقة.',
                'cards.*.position.integer' => 'يجب أن يكون ترتيب البطاقة رقماً.',
                'cards.*.position.in' => 'ترتيب البطاقة يجب أن يكون 1 أو 2 أو 3 فقط.',
            ...
            : [
                ...
                'cards.min' => 'Exactly three cards must be provided.',
                'cards.max' => 'Exactly three cards must be provided.',

                'cards.*.position.required' => 'Card position is required.',
                'cards.*.position.integer' => 'Card position must be a number.',
                'cards.*.position.in' => 'Position must be one of: 1, 2, or 3.',
